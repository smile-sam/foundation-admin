<template>
  <div class="flow-container">
    <div ref="content" class="containers">
      ...
      <el-tabs type="card" class="properties" size="large" v-model="activeName" @tab-click="handleClick">
        <el-tab-pane name="1" label="自定义面板">
          <el-tabs size="small" v-model="customActiveName" @tab-click="customHandleClick">
            <el-tab-pane name="1" label="常规">
              <General :general-modeler="modeler" :element-id="elementId" />
            </el-tab-pane>
            <el-tab-pane name="2" label="表单" force-render>
              <Forms />
            </el-tab-pane>
            <el-tab-pane name="3" label="扩展">
              这是扩展
            </el-tab-pane>
          </el-tabs>
        </el-tab-pane>
        <el-tab-pane id="properties" name="2" label="原生面板" />
      </el-tabs>
    </div>
  </div>
</template>
